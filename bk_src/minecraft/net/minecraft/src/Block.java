...
public class Block {
	...
	public static final Block hearthIdle = (new BlockHearth(105, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("hearth").disableNeighborNotifyOnMetadataChange();
	public static final Block hearthActive = (new BlockHearth(106, true)).setHardness(3.5F).setStepSound(soundStoneFootstep).setLightValue(14.0F / 16.0F).setBlockName("hearth").disableNeighborNotifyOnMetadataChange();
