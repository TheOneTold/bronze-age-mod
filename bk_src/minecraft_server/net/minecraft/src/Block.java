...
public class Block
{
    ...
    static 
    {
		...
		hearthIdle = (new BlockHearth(105, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("hearth");
		hearthActive = (new BlockHearth(106, true)).setHardness(3.5F).setStepSound(soundStoneFootstep).setLightValue(14.0F / 16.0F).setBlockName("hearth");
