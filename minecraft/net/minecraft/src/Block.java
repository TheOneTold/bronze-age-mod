...
public class Block {
	...
	public static final Block oreIron = (new BlockOre(15, 33)).setHardness(5.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreIron");
	...
	public static final Block doorWood = (new BlockDoor(64, Material.sticks)).setHardness(3.0F).setStepSound(soundWoodFootstep).setBlockName("doorWood").disableStats().disableNeighborNotifyOnMetadataChange();
	...
	public static final Block oreCopper = (new BlockOre(97, 30)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreCopper");
	public static final Block oreTin = (new BlockOre(98, 54)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreTin");
	public static final Block blockCopper = (new BlockOreStorage(99, 76)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockCopper");
	public static final Block blockTin = (new BlockOreStorage(100, 78)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockTin");
	public static final Block blockBronze = (new BlockOreStorage(101, 77)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundMetalFootstep).setBlockName("blockBronze");
	public static final Block sticks = (new BlockSticks(102, 85)).setHardness(0.5F).setResistance(3.0F).setStepSound(soundWoodFootstep).setBlockName("sticks").disableNeighborNotifyOnMetadataChange();
	public static final Block oreSilver = (new BlockOre(103, 100)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreSilver");
	public static final Block blockSilver = (new BlockOreStorage(104, 101)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockSilver");
	public static final Block hearthIdle = (new BlockHearth(105, false)).setHardness(1.0F).setStepSound(soundStoneFootstep).setBlockName("hearth").disableNeighborNotifyOnMetadataChange();
	public static final Block hearthActive = (new BlockHearth(106, true)).setHardness(1.0F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setBlockName("hearth").disableNeighborNotifyOnMetadataChange();
	public static final Block purifiedNetherstone = (new Block(107, 171, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstone");
	public static final Block netherstone = (new Block(108, 173, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstone");
	public static final Block smoothSandstone = (new Block(109, 175, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("smoothSandstone");
	public static final Block purifiedNetherstonePillar = (new BlockPillar(110, 170)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstonePillar");
	public static final Block netherstonePillar = (new BlockPillar(111, 172)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstonePillar");
	public static final Block sandstonePillar = (new BlockPillar(112, 174)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("sandstonePillar");
	public static final Block purifiedNetherstoneBricks = (new Block(113, 137, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstoneBricks");
	public static final Block netherstoneBricks = (new Block(114, 138, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstoneBricks");
	public static final Block sandstoneBricks = (new Block(115, 139, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("sandstoneBricks");
	public static final Block stoneBricks = (new Block(116, 136, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneBricks");
