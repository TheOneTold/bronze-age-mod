...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Item.bucketEmpty, 1), new Object[]{"# #", " # ", Character.valueOf('#'), Item.clay});
		...
		this.addRecipe(new ItemStack(Block.sandstonePillar, 2), new Object[]{"#", "#", Character.valueOf('#'), Block.smoothSandstone});
		this.addRecipe(new ItemStack(Block.purifiedNetherstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.purifiedNetherstone});
		this.addRecipe(new ItemStack(Block.netherstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.netherstone});
		this.addRecipe(new ItemStack(Block.sandstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.smoothSandstone});
		...
		this.addRecipe(new ItemStack(Block.slabGravelSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.gravel});
		this.addRecipe(new ItemStack(Block.slabWhiteConcreteSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.whiteConcrete});
		this.addRecipe(new ItemStack(Block.slabBlackConcreteSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.blackConcrete});
