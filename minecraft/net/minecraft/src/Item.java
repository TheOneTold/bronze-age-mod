...
public class Item {
	...
	public static Item appleRed = (new ItemFood(4, 4, false, 16)).setIconCoord(10, 0).setItemName("apple");
	...
	public static Item bread = (new ItemFood(41, 7, false, 16)).setIconCoord(9, 2).setItemName("bread");
	...
	public static Item porkRaw = (new ItemFood(63, 3, true, 16)).setIconCoord(7, 5).setItemName("porkchopRaw");
	public static Item porkCooked = (new ItemFood(64, 8, true, 16)).setIconCoord(8, 5).setItemName("porkchopCooked");
	public static Item painting = (new ItemPainting(65)).setIconCoord(10, 1).setItemName("painting");
	public static Item appleGold = (new ItemFood(66, 42, false, 16)).setIconCoord(11, 0).setItemName("appleGold");
	...
	public static Item bucketEmpty = (new ItemBucket(69, 0, 16)).setIconCoord(10, 4).setItemName("bucket");
	public static Item bucketWater = (new ItemBucket(70, Block.waterMoving.blockID, 1)).setIconCoord(11, 4).setItemName("bucketWater").setContainerItem(bucketEmpty);
	public static Item bucketLava = (new ItemBucket(71, Block.lavaMoving.blockID, 1)).setIconCoord(12, 4).setItemName("bucketLava").setContainerItem(bucketEmpty);
	...
	public static Item bucketMilk = (new ItemBucket(79, -1, 1)).setIconCoord(13, 4).setItemName("milk").setContainerItem(bucketEmpty);
	...
	public static Item fishRaw = (new ItemFood(93, 2, false, 16)).setIconCoord(9, 5).setItemName("fishRaw");
	public static Item fishCooked = (new ItemFood(94, 5, false, 16)).setIconCoord(10, 5).setItemName("fishCooked");
	...
	public static Item ingotCopper = (new Item(104)).setIconCoord(5, 6).setItemName("ingotCopper");
	public static Item ingotTin = (new Item(105)).setIconCoord(6, 6).setItemName("ingotTin");
	
	public static Item helmetCopper = (new ItemArmor(106, 1, 5, 0)).setIconCoord(5, 7).setItemName("helmetCopper");
	public static Item plateCopper = (new ItemArmor(107, 1, 5, 1)).setIconCoord(5, 8).setItemName("chestplateCopper");
	...
	public static Item legsBronze = (new ItemArmor(116, 2, 7, 2)).setIconCoord(12, 9).setItemName("leggingsBronze");
	public static Item bootsBronze = (new ItemArmor(117, 2, 7, 3)).setIconCoord(12, 10).setItemName("bootsBronze");
	
	public static Item swordCopper = (new ItemSword(118, EnumToolMaterial.COPPER)).setIconCoord(9, 6).setItemName("swordCopper");
	public static Item shovelCopper = (new ItemSpade(119, EnumToolMaterial.COPPER)).setIconCoord(9, 7).setItemName("shovelCopper");
	public static Item pickaxeCopper = (new ItemPickaxe(120, EnumToolMaterial.COPPER)).setIconCoord(9, 8).setItemName("pickaxeCopper");
	public static Item axeCopper = (new ItemAxe(121, EnumToolMaterial.COPPER)).setIconCoord(9, 9).setItemName("hatchetCopper");
	public static Item hoeCopper = (new ItemHoe(122, EnumToolMaterial.COPPER)).setIconCoord(9, 10).setItemName("hoeCopper");
	
	public static Item swordTin = (new ItemSword(123, EnumToolMaterial.TIN)).setIconCoord(10, 6).setItemName("swordTin");
	public static Item shovelTin = (new ItemSpade(124, EnumToolMaterial.TIN)).setIconCoord(10, 7).setItemName("shovelTin");
	public static Item pickaxeTin = (new ItemPickaxe(125, EnumToolMaterial.TIN)).setIconCoord(10, 8).setItemName("pickaxeTin");
	public static Item axeTin = (new ItemAxe(126, EnumToolMaterial.TIN)).setIconCoord(10, 9).setItemName("hatchetTin");
	public static Item hoeTin = (new ItemHoe(127, EnumToolMaterial.TIN)).setIconCoord(10, 10).setItemName("hoeTin");
	
	public static Item swordBronze = (new ItemSword(128, EnumToolMaterial.BRONZE)).setIconCoord(11, 6).setItemName("swordBronze");
	public static Item shovelBronze = (new ItemSpade(129, EnumToolMaterial.BRONZE)).setIconCoord(11, 7).setItemName("shovelBronze");
	public static Item pickaxeBronze = (new ItemPickaxe(130, EnumToolMaterial.BRONZE)).setIconCoord(11, 8).setItemName("pickaxeBronze");
	public static Item axeBronze = (new ItemAxe(131, EnumToolMaterial.BRONZE)).setIconCoord(11, 9).setItemName("hatchetBronze");
	public static Item hoeBronze = (new ItemHoe(132, EnumToolMaterial.BRONZE)).setIconCoord(11, 10).setItemName("hoeBronze");
	
	public static Item ingotBronze = (new Item(133)).setIconCoord(7, 7).setItemName("ingotBronze");
	public static Item ingotSilver = (new Item(134)).setIconCoord(13, 3).setItemName("ingotSilver");
	
	public static Item spearWood = (new ItemSpear(135, EnumToolMaterial.WOOD)).setIconCoord(0, 9).setItemName("spearWood");
	public static Item spearStone = (new ItemSpear(136, EnumToolMaterial.STONE)).setIconCoord(1, 9).setItemName("spearStone");
	public static Item spearIron = (new ItemSpear(137, EnumToolMaterial.IRON)).setIconCoord(2, 9).setItemName("spearIron");
	public static Item spearDiamond = (new ItemSpear(138, EnumToolMaterial.EMERALD)).setIconCoord(3, 9).setItemName("spearDiamond");
	public static Item spearGold = (new ItemSpear(139, EnumToolMaterial.GOLD)).setIconCoord(4, 9).setItemName("spearGold");
	public static Item spearCopper = (new ItemSpear(140, EnumToolMaterial.COPPER)).setIconCoord(0, 10).setItemName("spearCopper");
	...
	public static Item cupWood = (new Item(155)).setIconCoord(9, 11).setItemName("cupWood");
	public static Item cupWoodGrapeJuice = (new ItemDrink(156, 2, 3, 1)).setIconCoord(8, 11).setItemName("cupWoodGrapeJuice");
	public static Item cupWoodMilk = (new ItemDrink(157, 1, 3, 1)).setIconCoord(7, 11).setItemName("cupWoodMilk");
	public static Item cupWoodWine = (new ItemDrink(158, 3, 3, 1)).setIconCoord(6, 11).setItemName("cupWoodWine");
	public static Item cupBronze = (new Item(159)).setIconCoord(9, 12).setItemName("cupBronze");
	public static Item cupBronzeGrapeJuice = (new ItemDrink(160, 2, 3, 2)).setIconCoord(8, 12).setItemName("cupBronzeGrapeJuice");
	public static Item cupBronzeMilk = (new ItemDrink(161, 1, 3, 2)).setIconCoord(7, 12).setItemName("cupBronzeMilk");
	public static Item cupBronzeWine = (new ItemDrink(162, 3, 3, 2)).setIconCoord(6, 12).setItemName("cupBronzeWine");
	public static Item cupSilver = (new Item(163)).setIconCoord(9, 13).setItemName("cupSilver");
	public static Item cupSilverGrapeJuice = (new ItemDrink(164, 2, 3, 3)).setIconCoord(8, 13).setItemName("cupSilverGrapeJuice");
