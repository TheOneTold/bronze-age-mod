    ...
    implements IBlockAccess
{
    ...
    public int getBlockLightValue_do(int i, int j, int k, boolean flag)
    {
        ...
        {
            int l = getBlockId(i, j, k);
            if(l == Block.stairSingle.blockID || l == Block.tilledField.blockID || l == Block.stairCompactCobblestone.blockID || l == Block.stairCompactPlanks.blockID || l == Block.stairTiles.blockID || l == Block.stairShingles.blockID || l == Block.stairThatch.blockID || l == Block.slabThatchSingle.blockID || l == Block.slabShinglesSingle.blockID || l == Block.slabTileSingle.blockID)
            {
