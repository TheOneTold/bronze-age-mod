...
public class TileEntityHearth extends TileEntityFurnace

{
    ...
    public void updateEntity()
    {
        ...
        if(!worldObj.singleplayerWorld)
        {
            ...
            {
                flag1 = true;
                BlockHearth.updateHearthBlockState(furnaceBurnTime > 0, worldObj, xCoord, yCoord, zCoord);
            }
        }
        if(flag1)
        {
    ...
    public boolean canSmelt()
    {
        ...
        ItemStack itemstack = HearthRecipes.smelting().getSmeltingResult(furnaceItemStacks[0].getItem().shiftedIndex);
        if(itemstack == null)
        {
            return false;
        }
    ...
    private int getItemBurnTime(ItemStack itemstack)
    {
		...
		if(i == Block.hay.blockID)
        {
            return 300;
        }
		if(i == Block.sticks.blockID)
        {
            return 650;
        }
