...
public class WorldGenLead extends WorldGenerator
{
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        world.setBlockWithNotify(i, j, k, Block.oreLead.blockID);
        for(int l = 0; l < 1500; l++)
        {
            ...
            if(l1 == 1)
            {
                world.setBlockWithNotify(i1, j1, k1, Block.oreLead.blockID);
            }
        }
