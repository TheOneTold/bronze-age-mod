...
public class Item
{
    ...
    static 
    {
        ...
        bucketEmpty = (new ItemBucket(69, 0, 16)).setIconCoord(10, 4).setItemName("bucket");
        bucketWater = (new ItemBucket(70, Block.waterMoving.blockID, 1)).setIconCoord(11, 4).setItemName("bucketWater").setContainerItem(bucketEmpty);
        bucketLava = (new ItemBucket(71, Block.lavaMoving.blockID, 1)).setIconCoord(12, 4).setItemName("bucketLava").setContainerItem(bucketEmpty);
