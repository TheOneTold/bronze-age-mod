...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
		...
		addRecipe(new ItemStack(Block.sandstonePillar, 2), new Object[]{"#", "#", Character.valueOf('#'), Block.smoothSandstone});
		addRecipe(new ItemStack(Block.purifiedNetherstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.purifiedNetherstone});
		addRecipe(new ItemStack(Block.netherstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.netherstone});
		addRecipe(new ItemStack(Block.sandstoneBricks, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.smoothSandstone});
		...
		addRecipe(new ItemStack(Block.stairShingles, 4), new Object[]{"#  ", "## ", "###", Character.valueOf('#'), Block.flintBricks});
		addRecipe(new ItemStack(Block.stairTiles, 4), new Object[]{"#  ", "## ", "###", Character.valueOf('#'), Block.tileBricks});
		addRecipe(new ItemStack(Block.slabShinglesSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.flintBricks});
		...
		addRecipe(new ItemStack(Block.slabGravelSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.gravel});
		addRecipe(new ItemStack(Block.slabWhiteConcreteSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.whiteConcrete});
		addRecipe(new ItemStack(Block.slabBlackConcreteSingle, 3), new Object[]{"###", Character.valueOf('#'), Block.blackConcrete});
