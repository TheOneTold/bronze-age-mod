...
public class Block
{
	...
	public static final Block oreTin;
	public static final Block blockCopper;
	public static final Block blockTin;
	public static final Block blockBronze;
	public static final Block sticks;
	public static final Block oreSilver;
	public static final Block blockSilver;
	public static final Block hearthIdle;
	public static final Block hearthActive;
	public static final Block purifiedNetherstone;
	public static final Block netherstone;
	public static final Block smoothSandstone;
	public static final Block purifiedNetherstonePillar;
	public static final Block netherstonePillar;
	public static final Block sandstonePillar;
	public static final Block purifiedNetherstoneBricks;
	public static final Block netherstoneBricks;
	public static final Block sandstoneBricks;
	...
	public static final Block mill;
	public static final Block oreLead;
	public static final Block blockLead;
    ...
    static 
    {
        ...
        oreCopper = (new BlockOre(97, 30)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreCopper");
		oreTin = (new BlockOre(98, 54)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreTin");
		blockCopper = (new BlockOreStorage(99, 76)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockCopper");
		blockTin = (new BlockOreStorage(100, 78)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockTin");
		blockBronze = (new BlockOreStorage(101, 77)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundMetalFootstep).setBlockName("blockBronze");
		sticks = (new BlockSticks(102, 85)).setHardness(0.5F).setResistance(3.0F).setStepSound(soundWoodFootstep).setBlockName("sticks");
		oreSilver = (new BlockOre(103, 100)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreSilver");
		blockSilver = (new BlockOreStorage(104, 101)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockSilver");
		hearthIdle = (new BlockHearth(105, false)).setHardness(1.0F).setStepSound(soundStoneFootstep).setBlockName("hearth");
		hearthActive = (new BlockHearth(106, true)).setHardness(1.0F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setBlockName("hearth");
		purifiedNetherstone = (new Block(107, 171, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstone");
		netherstone = (new Block(108, 173, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstone");
		smoothSandstone = (new Block(109, 175, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("smoothSandstone");
		purifiedNetherstonePillar = (new BlockPillar(110, 170)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstonePillar");
		netherstonePillar = (new BlockPillar(111, 172)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstonePillar");
		sandstonePillar = (new BlockPillar(112, 174)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("sandstonePillar");
		purifiedNetherstoneBricks = (new Block(113, 137, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("purifiedNetherstoneBricks");
		netherstoneBricks = (new Block(114, 138, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("netherstoneBricks");
		sandstoneBricks = (new Block(115, 139, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("sandstoneBricks");
		stoneBricks = (new Block(116, 136, Material.rock)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneBricks");
		hay = (new BlockHay(117, 153)).setHardness(0.5F).setResistance(3.0F).setStepSound(soundGravelFootstep).setBlockName("hay");
